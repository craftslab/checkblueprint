...
ldflags="-s -w -X github.com/craftslab/checkblueprint/config.Build=$build -X github.com/craftslab/checkblueprint/config.Version=$version"
target="checkblueprint"
